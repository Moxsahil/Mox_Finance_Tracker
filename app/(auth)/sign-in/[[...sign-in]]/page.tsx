...
import { Loader2, Shield, TrendingUp, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className='min-h-screen relative bg-neutral-50 dark:bg-neutral-950 overflow-hidden'>
      ...
      <div className="absolute inset-0 opacity-30 dark:opacity-20">
        ...
        <div className="absolute bottom-0 left-1/2 w-80 h-80 bg-indigo-300 dark:bg-indigo-600 rounded-full mix-blend-multiply dark:mix-blend-lighten filter blur-3xl animate-blob animation-delay-4000"></div>
      </div>
