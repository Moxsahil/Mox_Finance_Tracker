    ...
    async(c) => {
        ...
        async function fetchFinancialData(userId: string, startDate: Date, endDate: Date) {
            ...
            .select({
                ...
                remainingBalance: sum(transactions.amount).mapWith(Number),
            }).
            from(transactions)
        ...
        const remainingBalanceChange = calculatePercentageChange(currentPeriod.remainingBalance, lastPeriod.remainingBalance);
        ...
        return c.json({
            ...
            expensesChange,
            remainingBalanceAmount: currentPeriod.remainingBalance,
            remainingBalanceChange,
